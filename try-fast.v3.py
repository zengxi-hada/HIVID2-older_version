...
# read two raw fastq files
def read_seq(fq1, fq2):
	dic1={}
	dic2={}
	with gzip.open(fq1, "r") as handle1:
		for r1 in SeqIO.parse(handle1, "fastq"):
			dic1[str(r1.id)]=str(r1.seq)
	with gzip.open(fq2, "r") as handle2:
 		for r2 in SeqIO.parse(handle2, "fastq"):
 			dic2[str(r2.id)]=str(r2.seq)
 	return dic1,dic2

#获得fq文件里某一id的read的seq,返回字典
def get_seq(dic1,dic2,id_list):
	new_dic1={}
	new_dic2={}
	for id in id_list:
#		print id
#		print  dic1.has_key(id)
		if dic1.has_key(id):
			new_dic1[id]=dic1[id]
		if dic2.has_key(id):
			new_dic2[id]=dic2[id]
...
dic1,dic2 = read_seq(cmd_args.fq1, cmd_args.fq2)
new_dic1 = {}
new_dic2 = {}
...
#						print "#"+uniq_id_list1[0]
						...
						#print id_list1
						uniq_list=[]
						new_dic1,new_dic2=get_seq(dic1,dic2,id_list1)
						uniq_id_list1=get_uniq(new_dic1,new_dic2)
#						print "#"+uniq_id_list1[0]
...
#						print "#"+uniq_id_list2[0]
						...
						#print id_list2
						uniq_list=[]
						new_dic1,new_dic2=get_seq(dic1,dic2,id_list2)
						uniq_id_list2=get_uniq(new_dic1,new_dic2)
#						print "#"+uniq_id_list2[0]
...
##							print ids3
						#print id_list3
						uniq_list=[]
						new_dic1,new_dic2=get_seq(dic1,dic2,id_list3)
#						print "test"
						uniq_id_list3=get_uniq(new_dic1,new_dic2)
#						print "#"+uniq_id_list3[0]
...
#				print output1+"\t"+left_support+"\t"+right_support+"\t"+disc_support+"\t"+total_support+"\t"+norm_left+"\t"+norm_right+"\t"+norm_disc+"\t"+norm_sum+"\t"+left_reads_ID+"\t"+right_reads_ID+"\t"+disc_reads_ID
#				print left_reads_ID+"\t"+right_reads_ID+"\t"+disc_reads_ID
